// ============================================================
// DATA: 2026 FIFA World Cup - All 48 Teams + Special Sections
// Organized by official group draw order
// ============================================================

const COUNTRIES = [
  // ── Seção Especial FWC ──
  { code: "FWC", name: "FWC Especial",    flag: "✨", group: "FWC", count: 20, startZero: true },
  ...
  { code: "COD", name: "Congo",            flag: "🇨🇩", group: "K" },
  ...
  // ── Coca Cola ──
  { code: "COC", name: "Coca Cola",        flag: "🥤", group: "Extra", count: 14 },
];

// Default count per country
